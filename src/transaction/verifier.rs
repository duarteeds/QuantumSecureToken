use pqcrypto_dilithium::dilithium5::{PublicKey, verify_detached_signature, DetachedSignature};
...
impl TransactionVerifier {
    pub fn verify(&self, data: &[u8], signature: &[u8], public_key: &PublicKey) -> Result<(), TransactionError> {
