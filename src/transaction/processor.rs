...
use crate::constants::{MIN_AMOUNT, MAX_AMOUNT, TIMESTAMP_WINDOW, MAX_SIGNATURE_SIZE};
use super::builder::{Transaction, NonceRegistry};
...
impl TransactionProcessor {
    pub fn validate(&self, transaction: &Transaction, nonce_registry: &mut NonceRegistry) -> Result<(), TransactionError> {
