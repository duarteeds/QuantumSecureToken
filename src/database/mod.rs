...
impl Database {
    pub fn new(db_path: &str) -> Result<Self> {
        ...
        let conn = Connection::open(db_path)
            .context("Falha ao abrir conexão com banco de dados")?;
    ...
    pub fn insert_transaction(&self, from: &str, to: &str, amount: u64, timestamp: i64, signature: &[u8], public_key: &[u8]) -> Result<()> {
        self.conn.execute(
    ...
    pub fn get_transactions_by_address(&self, address: &str) -> Result<Vec<(String, String, u64, i64)>> {
